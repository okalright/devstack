...
(function() {
  var AuthList, AuthListWidget, AutoEnrollmentViaCsv, BatchEnrollment, BetaTesterBulkAddition, MemberListWidget, Membership, emailStudents, plantTimeout, std_ajax_err,
  ...
  AutoEnrollmentViaCsv = (function() {
    ...
    AutoEnrollmentViaCsv.prototype.display_response = function(data_from_server) {
      ...
      render_response = function(label, type, student_results) {
        var message_title, messages_copy, messages_summary, response_message, student_result, task_res_section, _l, _len3;
        if (type === 'success') {
          task_res_section = $('<div/>', {
            "class": 'message message-confirmation'
          });
          message_title = $('<h3/>', {
            "class": 'message-title',
            text: label
          ...
          _this.$results.append(task_res_section);
          return;
        }
        if (type === 'error') {
          task_res_section = $('<div/>', {
        ...
        messages_summary = $('<ul/>', {
          "class": 'list-summary summary-items'
        });
        ...
        for (_l = 0, _len3 = student_results.length; _l < _len3; _l++) {
          ...
          messages_summary.append($('<li/>', {
            "class": 'summary-item',
            text: response_message
          }));
        }
        return _this.$results.append(task_res_section);
      };
      if (errors.length) {
      ...
      if (result_from_server_is_success) {
        return render_response(gettext("All accounts were created successfully."), 'success', []);
      }
    };
