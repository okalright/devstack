  ...
  describe("XBlock", function() {
    ...
    describe("initializeBlock", function() {
      ...
      return it("passes through the request token", function() {
        expect(XBlock.initializeBlocks).toHaveBeenCalledWith($(this.vANode), 'req-token-a');
        return expect(XBlock.initializeBlocks).toHaveBeenCalledWith($(this.vZNode), 'req-token-z');
      });
    });
